...
pub1 = rospy.Publisher('/right_elbow_controller/command', Float64)
pub2 = rospy.Publisher('/left_elbow_controller/command', Float64)
pub3 = rospy.Publisher('/right_collar_controller/command', Float64)
pub4 = rospy.Publisher('/left_collar_controller/command', Float64)
pub5 = rospy.Publisher('/right_upper_controller/command', Float64)
pub6 = rospy.Publisher('/left_upper_controller/command', Float64)
pub7 = rospy.Publisher('/head_controller/command', Float64)
pub8 = rospy.Publisher('/neck_controller/command', Float64)
